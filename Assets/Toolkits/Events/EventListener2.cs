...
namespace Toolkits.Events
{
    ...
    public abstract class EventListener<T1, T2> : MonoBehaviour
    {
        ...
        [SerializeField] private EventChannelSO<T1, T2> _channel = null;
        ...
        [SerializeField] private UnityEvent<T1, T2> _onRaised = null;
        ...
        private void Raise(T1 parameter1, T2 parameter2) => _onRaised?.Invoke(parameter1, parameter2);
    }
}
